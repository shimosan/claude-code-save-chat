...
3. local patch / recovery utility の実行・確認をユーザーが求めた時だけ: `<library_path>/scripts/config-apply-patches.md`
...
- patch / recovery utility の要求では `scripts/config-apply-patches.md` を読む。詳細は script-specific docs に置き、live 変更前には明示承認を得る。
