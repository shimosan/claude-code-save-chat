...
使い方:  python config-snapshot-win.py            # JSON を stdout に表示
         python config-snapshot-win.py --scratch  # <repo>\\scratch\\config_<machine>_YYYY-MM-DD_HH-MM-SS.json に書く
...
DEFAULTS = {
    ...
    "claude_local_md": os.path.join(HOME, ".claude", "CLAUDE.local.md"),
}
