...
- [`config-apply-patches.md`](config-apply-patches.md): agent-facing index for optional local patch and recovery utilities. Separate from snapshot-driven apply recipes.
